...
@Component
public class AihumanRealConfigVoToAihumanRealConfigMapperImpl implements AihumanRealConfigVoToAihumanRealConfigMapper {

    @Override
    public AihumanRealConfig convert(AihumanRealConfigVo arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public AihumanRealConfig convert(AihumanRealConfigVo arg0, AihumanRealConfig arg1) {
        if ( arg0 == null ) {
            return arg1;
        }
