...
@Component
public class ChatUsageTokenBoToChatUsageTokenMapperImpl implements ChatUsageTokenBoToChatUsageTokenMapper {

    @Override
    public ChatUsageToken convert(ChatUsageTokenBo arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public ChatUsageToken convert(ChatUsageTokenBo arg0, ChatUsageToken arg1) {
        if ( arg0 == null ) {
            return arg1;
        }
