...
@Component
public class AihumanConfigBoToAihumanConfigMapperImpl implements AihumanConfigBoToAihumanConfigMapper {

    @Override
    public AihumanConfig convert(AihumanConfigBo arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public AihumanConfig convert(AihumanConfigBo arg0, AihumanConfig arg1) {
        if ( arg0 == null ) {
            return arg1;
        }
