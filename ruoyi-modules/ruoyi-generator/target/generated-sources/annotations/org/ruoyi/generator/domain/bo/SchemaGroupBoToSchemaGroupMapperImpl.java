...
@Component
public class SchemaGroupBoToSchemaGroupMapperImpl implements SchemaGroupBoToSchemaGroupMapper {

    @Override
    public SchemaGroup convert(SchemaGroupBo arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public SchemaGroup convert(SchemaGroupBo arg0, SchemaGroup arg1) {
        if ( arg0 == null ) {
            return arg1;
        }
