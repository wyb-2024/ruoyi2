...
@Component
public class McpInfoVoToMcpInfoMapperImpl implements McpInfoVoToMcpInfoMapper {

    @Override
    public McpInfo convert(McpInfoVo arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public McpInfo convert(McpInfoVo arg0, McpInfo arg1) {
        if ( arg0 == null ) {
            return arg1;
        }
