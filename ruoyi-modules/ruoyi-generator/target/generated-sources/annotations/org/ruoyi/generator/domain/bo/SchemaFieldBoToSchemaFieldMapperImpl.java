...
@Component
public class SchemaFieldBoToSchemaFieldMapperImpl implements SchemaFieldBoToSchemaFieldMapper {

    @Override
    public SchemaField convert(SchemaFieldBo arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public SchemaField convert(SchemaFieldBo arg0, SchemaField arg1) {
        if ( arg0 == null ) {
            return arg1;
        }
